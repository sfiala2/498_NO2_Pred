...
Future research may include incoportating more data sources to paint a more detailed picture of the variations across the United States. Additionally, with more sources of data, future versions of this model could be used to predict NO<sub>2</sub> concentrations outside of the United States.
