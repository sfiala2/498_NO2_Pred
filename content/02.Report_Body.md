...
The mean squared error was choosen for the loss function because of its directly proportional to root-mean square error and the Adam optimizer was choosen to allow for the quickest convergence.
