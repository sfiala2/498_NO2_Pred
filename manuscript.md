...
## 2.1.3 Comparison of PM<sub>2.5</sub> and AQI/API studies
...
![Figure 2.1 Histogram of NO<sub>2</sub> concentrations](images/Histogram_NO2.png)
...
Figure 3.3 shows the predicted values of the known testing data. The model was run on 165 samples (139 of the testing data and 26 hidden values) and the root mean squared error was found to be 2.925 ppb, which is lower than the root mean squared error on the training data (3.05 ppb). 
